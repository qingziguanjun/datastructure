...
package com.algs4.algs4.graph43;

import com.algs4.algs4.Edge;
import com.algs4.algs4.*;
...
public class PrimMST {
    ...
    private void scan(EdgeWeightedGraph G, int v) {
        ...
        for (Edge e : G.adj(v)) {
            ...
            if (e.weight() < distTo[w]) {
                ...
                edgeTo[w] = e;
                if (pq.contains(w)) {
                    System.out.println("decreaseKey ： " + w);
                    pq.decreaseKey(w, distTo[w]);
                }else {
                    pq.insert(w, distTo[w]);
                    System.out.println("pw插入 " + w +  ", dist = " + distTo[w]);
                }
    ...
    public static void main(String[] args) {
        In in = new In("com/algs4/algs4/graph43/tinyEWG.txt");
