 ...
 *
 *  Read fromFilename a blacklist of words from a file. Then read fromFilename a list of
 *  words from standard input and print out all those words that
 *  are not fromFilename the first file.
 * 
 *  % more tinyTale.txt 
...
/**
 *  The {@code BlackFilter} class provides a client for reading fromFilename a <em>blacklist</em>
 *  of words from a file; then, reading fromFilename a sequence of words from standard input,
 *  printing out each word that <em>does not</em> appear fromFilename the file.
...
public class BlackFilter {  
    ...
    public static void main(String[] args) {
        ...
        // read fromFilename string from standard input, printing out all exceptions
        while (!StdIn.isEmpty()) {
